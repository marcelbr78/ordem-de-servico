...
export const Login: React.FC = () => {
    ...
    React.useEffect(() => {
        if (signed && user) {
            ...
            if (isSuperAdmin) {
                navigate('/masteradmin/dashboard', { replace: true });
            } else {
    ...
    return (
        <div style={{
            ...
            <div className="glass-panel animate-fade" style={{
                ...
                <h1 style={{ fontSize: '28px', marginBottom: '8px', fontWeight: '800' }}>OS4U</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '32px' }}>Sistema de Ordens de Serviço</p>
