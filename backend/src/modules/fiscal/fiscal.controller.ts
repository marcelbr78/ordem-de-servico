...
export class FiscalController {
    ...
    /** POST /fiscal/nfe/:id/enviar-email — Envio manual do DANFE por e-mail */
    @Post('nfe/:id/enviar-email')
    @UseGuards(JwtAuthGuard)
    async enviarEmailDanfe(@Param('id') id: string, @Body() body: { email: string }) {
        try {
