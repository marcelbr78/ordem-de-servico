...
export class OrderService {
    ...
    // Recibo de entrega digital
    @Column({ type: 'text', nullable: true }) receiptSignature: string;   // base64 PNG
    @Column({ nullable: true }) receiptSignerName: string;
    @Column({ nullable: true }) receiptSignerDoc: string;
    @Column({ nullable: true }) receiptNotes: string;
    @Column({ nullable: true }) receiptAt: Date; // Dias de garantia após entrega

    @Column({ nullable: true })
    warrantyExpiresAt: Date; // Data de vencimento da garantia
